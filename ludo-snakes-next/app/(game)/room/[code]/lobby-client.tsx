        ...
        <div className="space-y-3">
          {players.map((player, idx) => {
            ...
            return (
              <div
                key={player.id}
                className="flex items-center gap-3 p-3.5 rounded-2xl animate-slide-in"
                style={{
                  background: cfg.bg,
          ...
          {Array.from({ length: 4 - players.length }).map((_, i) => (
            ...
            >
              ...
              <p className="text-sm" style={{ color: "var(--t3)" }}>
                Menunggu pemain ke-{players.length + i + 1}...
              </p>
            </div>
          ))}
        </div>
      ...
      >
        {isHost ? (
          <>
            ...
            >
              {canStart
                ? "✅ Semua siap! Mulai gamenya sekarang."
